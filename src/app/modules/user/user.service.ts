...
export const createDoctor = async (req: Request): Promise<Doctor> => {
  const file = req.file;
...
export const getAllFromDB = async (params: any, options: IOptions) => {
...
export const getMyProfile = async (user: IJWTPayload) => {
...
export const changeProfileStatus = async (
  id: string,
...
export const updateMyProfile = async (req: Request) => {
  const userInfo = await prisma.user.findUniqueOrThrow({
    where: {
