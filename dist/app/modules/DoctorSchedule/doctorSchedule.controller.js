...
const insertIntoDB = (0, catchAsync_1.default)(async (req, res) => {
    const user = req.user;
    const result = await doctorSchedule_service_1.DoctorScheduleService.insertIntoDB(user, req.body);
...
const getMySchedule = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const user = req.user;
    const result = await doctorSchedule_service_1.DoctorScheduleService.getMySchedule(filters, options, user);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const getAllFromDB = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const options = (0, pick_1.default)(req.query, ['limit', 'page', 'sortBy', 'sortOrder']);
    const result = await doctorSchedule_service_1.DoctorScheduleService.getAllFromDB(filters, options);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
