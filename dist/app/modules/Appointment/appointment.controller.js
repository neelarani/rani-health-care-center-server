...
const changeAppointmentStatus = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const user = req.user;
    const result = await appointment_service_1.AppointmentService.updateAppointmentStatus(id, status, user);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const createAppointmentWithPayLater = (0, catchAsync_1.default)(async (req, res) => {
    const user = req.user;
    const result = await appointment_service_1.AppointmentService.createAppointmentWithPayLater(user, req.body);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const initiatePayment = (0, catchAsync_1.default)(async (req, res) => {
    const user = req.user;
    const { id } = req.params;
    const result = await appointment_service_1.AppointmentService.initiatePaymentForAppointment(id, user);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
